const sectionDataAbout = [
    ...
    },
    {
      ...
      mainText: '',
      description:
        'Looking to the future, we are undaunted in the pursuit of our purpose, and it continues to inform all our decisions on the ground. The breathtaking landscapes of our reserves and concessions form the perfect backdrop for the stillness our guests seek and we are dedicated to creating exclusive sanctuaries that inspire a soul-restoring sense of calm – lodges, camps and villas providing restful retreats; and wide-open spaces revealing the magic of the mountains. We will only develop new properties that are better than, or as good as, the ones we already have and this disciplined approach ensures that we continue delivering unparalleled guest experience, remain steadfast in our commitment to our purpose, and keep benefiting the land and communities in which we operate.',
